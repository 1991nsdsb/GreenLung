 ...
 */
//s32 bma2x2_data_readout_template(s16 *accel_z);
/*----------------------------------------------------------------------------*
 ...
 *-------------------------------------------------------------------------*/
	...
	NRF_LOG_INFO("bma2x2_init error is d%.\r\n",com_rslt);
...
s8 BMA2x2_I2C_bus_write(u8 dev_addr, u8 reg_addr, u8 *reg_data, u8 cnt)
{
    ...
    iError =  twi_master_transfer(dev_addr, array, cnt+1, TWI_ISSUE_STOP);
	/*
...
s8 BMA2x2_I2C_bus_read(u8 dev_addr, u8 reg_addr, u8 *reg_data, u8 cnt)
{
    ...
    transfer_succeeded  = twi_master_transfer(dev_addr, array, 1, TWI_DONT_ISSUE_STOP);
    transfer_succeeded &= twi_master_transfer(dev_addr|TWI_READ_BIT, array, cnt, TWI_ISSUE_STOP);
