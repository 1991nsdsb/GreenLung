...
#define		BMA2x2_INTERFACE_IDLE_TIME_DELAY	((uint8_t)1)
...
#define         BMA2x2_FIFO_XYZ_AXES_FRAME_SIZE       ((uint8_t)6)
#define         BMA2x2_FIFO_SINGLE_AXIS_FRAME_SIZE    ((uint8_t)2)
	/**	MODE RANGES    */
...
struct fifo_configuration {
	...
	uint8_t accel_byte_start_index;
...
/**\name  MODE SETTINGS     */
/******************************************/
#define BMA2x2_MODE_NORMAL             (0x00)
#define BMA2x2_MODE_LOWPOWER1          (0x40)
#define BMA2x2_MODE_SUSPEND            (0x80)
#define BMA2x2_MODE_DEEP_SUSPEND       (0x20)
...
/**
 * @brief Function for initializing BMA253 and verifies it's on the bus.
 *
 * @param device_address Device TWI address in bits [6:0].
 * @return
 * @retval true BMA253 found on the bus and ready for operation.
 * @retval false BMA253 not found on the bus or communication failure.
 */
bool BMA253_init(void);

/**
  @brief Function for writing a BMA253 register contents over TWI.
...
*/
bool BMA253_register_write(uint8_t register_address, const uint8_t value);

/**
  @brief Function for reading BMA253 register contents over TWI.
