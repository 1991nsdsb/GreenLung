...
#define M_BATT_MEAS_TYPE_LITHIUM_CR2032 4

#define M_BATT_MEAS_BATTERY_TYPE M_BATT_MEAS_TYPE_LITHIUM_CR2032 /** The battery type used */
...
#elif (M_BATT_MEAS_BATTERY_TYPE == M_BATT_MEAS_TYPE_LITHIUM_CR2032)
    #define M_BATT_MEAS_MIN_LEVEL 2200  /** Which voltage is considered to be 0% battery level [mV] */
    #define M_BATT_MEAS_MAX_LEVEL 3000 /** Which voltage is considered to be 100% battery level [mV] */
#else
